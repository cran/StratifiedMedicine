...
A forest plot provides an alternative view of the subgroup-specific treatment estimates with readable splitting rules:
```{r user_SM_forest, warnings=FALSE, message=FALSE, fig.width=10, fig.height=5}
