---
title: "User-specific Models: StratifiedMedicine"
...
Finally, let's input these user-specific functions into each step along with combining the components with PRISM:
