...
An alternative to the tree plot is the forest plot, which shows subgroup-specific treatment effect estimates with human-readable splitting rules alongside confidence intervals:
```{r default_ctns_forest, warning=FALSE, fig.width=10, fig.height=5}
...
The forest plot for survival data (with hazard ratios) uses a reference line at 1:
```{r default_surv_forest, warning=FALSE, fig.width=10, fig.height=5}
